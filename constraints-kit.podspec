#
#  Be sure to run `pod spec lint constraints-kit.podspec' to ensure this is a
...
s.name         = "constraints-kit"
s.version      = "1.0.0"
s.summary      = "🏗 Declarative, Chainable & Lightweight Auto Layout constraints framework for iOS"
...
s.homepage     = "https://github.com/jVirus/constraints-kit"
...
# "#{s.version}"
s.source       = { :git => "https://github.com/jVirus/constraints-kit.git", :tag => s.version.to_s }
...
s.source_files = "constraints-kit/constraints-kit//**/*.swift"
